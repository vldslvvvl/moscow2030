...
const Listing: React.FC = () => {
  ...
  const apartmentData: PropertyItem[] = [
    ...
    },
    {
      id: 4,
      type: "apartment",
      title: "3-комн. квартира на продажу, 71,3 м²",
      price: "19 201 090 ₽",
  ...
  const commercialData: PropertyItem[] = [
    {
      id: 1,
      type: "commercial",
      title: "Нежилое помещение на продажу, 96,2 м²",
      price: "21 170 000 ₽",
      image: "/src/assets/images/mock/commerce/1/1.jpg",
      area: "96,2м²",
      mainImage: "/src/assets/images/mock/commerce/1/1.jpg",
      thumbnails: [
        "/src/assets/images/mock/commerce/1/1.jpg",
        "/src/assets/images/mock/commerce/1/2.jpg",
        "/src/assets/images/mock/commerce/1/3.jpg",
        "/src/assets/images/mock/commerce/1/4.jpg",
      ],
      advantages: [
        "прозрачные условия сделки",
        "заключение договора напрямую с городом без посредников",
    ...
    },
    {
      id: 2,
      type: "commercial",
      title: "Нежилое помещение на продажу, 78 м²",
      price: "15 886 000 ₽",
      image: "/src/assets/images/mock/commerce/2/1.jpg",
      area: "78м²",
      mainImage: "/src/assets/images/mock/commerce/2/1.jpg",
      thumbnails: [
        "/src/assets/images/mock/commerce/2/1.jpg",
        "/src/assets/images/mock/commerce/2/2.jpg",
        "/src/assets/images/mock/commerce/2/3.jpg",
        "/src/assets/images/mock/commerce/2/4.jpg",
      ],
      advantages: [
        "прозрачные условия сделки",
        "заключение договора напрямую с городом без посредников",
    ...
    },
    {
      id: 3,
      type: "commercial",
      title: "Нежилое помещение на продажу, 69,3 м²",
      price: "18 950 000 ₽",
      image: "/src/assets/images/mock/commerce/3/1.jpg",
      area: "69,3м²",
      mainImage: "/src/assets/images/mock/commerce/3/1.jpg",
      thumbnails: [
        "/src/assets/images/mock/commerce/3/1.jpg",
        "/src/assets/images/mock/commerce/3/2.jpg",
        "/src/assets/images/mock/commerce/3/3.jpg",
        "/src/assets/images/mock/commerce/3/4.jpg",
      ],
      advantages: [
        "прозрачные условия сделки",
        "заключение договора напрямую с городом без посредников",
    ...
    },
    {
      id: 4,
      type: "commercial",
      title: "Нежилое помещение на продажу, 94,8 м²",
      price: "21 144 000 ₽",
      image: "/src/assets/images/mock/commerce/4/1.jpg",
      area: "94,8м²",
      mainImage: "/src/assets/images/mock/commerce/4/1.jpg",
      thumbnails: [
        "/src/assets/images/mock/commerce/4/1.jpg",
        "/src/assets/images/mock/commerce/4/2.jpg",
        "/src/assets/images/mock/commerce/4/3.jpg",
        "/src/assets/images/mock/commerce/4/4.jpg",
      ],
      advantages: [
        "прозрачные условия сделки",
        "заключение договора напрямую с городом без посредников",
